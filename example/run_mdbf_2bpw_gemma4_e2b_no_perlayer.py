#!/usr/bin/env python3
"""Gemma 4 E2B: MDBF 2.0bpw, per_layer_* kept FP16 (ablation config).
...
TARGET_BITS = 2.0
L, P = 8, 1
OUTPUT_FILE = Path(__file__).parent / "results_gemma4_e2b_2bpw_no_perlayer.json"
logging.basicConfig(level=logging.INFO, format="%(levelname)s %(message)s")


def main():
    print("=" * 80)
    print("Gemma 4 E2B: 2.0bpw, per_layer_* FP16 (attn/MLP only)")
