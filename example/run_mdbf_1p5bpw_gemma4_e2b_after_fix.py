#!/usr/bin/env python3
"""Gemma 4 E2B MDBF 1.5bpw (paper settings) - after fix + text generation.
GPU: cuda:2
"""
...
TARGET_BITS = 1.5
L, P = 8, 1
OUTPUT_FILE = Path(__file__).parent / "results_gemma4_e2b_1p5bpw_after_fix.json"
logging.basicConfig(level=logging.INFO, format="%(levelname)s %(message)s")


def main():
    print("=" * 80)
    print("Gemma 4 E2B MDBF 1.5bpw (paper) - AFTER FIX + generation")
