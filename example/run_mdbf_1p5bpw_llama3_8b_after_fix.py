#!/usr/bin/env python3
"""Meta-Llama-3-8B MDBF 1.5bpw (paper settings) - after fix + text generation.
GPU: cuda:2
"""
...
MODEL_PATH = "/data3/yoshida/qep-dev/models/Meta-Llama-3-8B"
DEVICE = "cuda:2"
TARGET_BITS = 1.5
L, P = 8, 1
OUTPUT_FILE = Path(__file__).parent / "results_llama3_8b_1p5bpw_after_fix.json"
...
def main():
    print("=" * 80)
    print("Meta-Llama-3-8B MDBF 1.5bpw (paper) - AFTER FIX + generation")
    print(f"  l={L}, P={P}, act_init=osvd, activation_aware=True")
    ...
    print(f"\n{'='*80}\n[RESULT] Llama-3-8B 1.5bpw after_fix\n  PPL: {ppl}\n  ACC: {acc}\n  Elapsed: {elapsed:.0f}s\n{'='*80}")
